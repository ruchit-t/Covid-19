# Covid-19
<h1>Web Application to track Covid-19 data!</h1>
<h2> Hey there! I'm Ruchit 👋 </h2>
...
<h3> Step 2: create virtual environment: 'python -m venv <env_name>' </h3>

<h3> Step 3: Activate the environment: '<env_name>\Scripts\activate' </h3>
